...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    if ([_delegate respondsToSelector:@selector(videosView:didSelected:)]) {
        [_delegate videosView:self didSelected:currentPage];
    }
}

- (void)setSelected:(NSInteger)index{
    [_scrollView setContentOffset:CGPointMake(320*index, 0) animated:YES];
}
@end