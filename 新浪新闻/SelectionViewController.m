...
- (void)viewDidLoad
{
    ...
    _httpRequest=[[BlockHttpRequest alloc]initWithUrlString:[NSString stringWithFormat:kUrlString,@"video_video"] finishedBlock:^(NSData *data){
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([model.playnumberString length]>5) {
        NSString *str=[model.playnumberString substringToIndex:2] ;
        [videosCell.playnumberLabel setText:[NSString stringWithFormat:@"%@万",str]];
    }else{
