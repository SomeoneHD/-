...
- (void)viewDidLoad
{
    ...
    _httpRequest=[[BlockHttpRequest alloc]initWithUrlString:[NSString stringWithFormat:kUrlString,@"local_beijing"] finishedBlock:^(NSData *data){
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [newsDetail setTabBar:self.tabBarController];
    [self.navc pushViewController:newsDetail animated:NO];
}
