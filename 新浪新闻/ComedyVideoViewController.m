...
@interface ComedyVideoViewController ()
{
...
@implementation ComedyVideoViewController
...
- (void)viewDidLoad
{
    ...
    _httpRequest=[[BlockHttpRequest alloc]initWithUrlString:[NSString stringWithFormat:kUrlString,@"video_funny"] finishedBlock:^(NSData *data){
