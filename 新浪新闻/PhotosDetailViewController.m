...
- (void)viewDidLoad
{
    ...
    NSURL *url=[NSURL URLWithString:_photosModel.linkString]; //请求网址
...
- (void)createNav{
    ...
    [likeBtn setBackgroundImage:[UIImage imageNamed:@"navigationBarItem_liked_normal"] forState:UIControlStateSelected];
    ...
    [saveBtn setBackgroundImage:[UIImage imageNamed:@"navigationBarItem_favorited_normal"] forState:UIControlStateSelected];
