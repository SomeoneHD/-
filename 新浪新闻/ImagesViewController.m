...
- (void)viewDidLoad
{
    ...
    _httpRequest=[[BlockHttpRequest alloc]initWithUrlString:[NSString stringWithFormat:kUrlString,@"hdpic_toutiao"] finishedBlock:^(NSData *data){
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    PhotosDetailViewController *photoDetail=[[PhotosDetailViewController alloc]initWithModel:model];
    [photoDetail setTabBar:self.tabBarController];
    [self.navc pushViewController:photoDetail animated:NO];
}
